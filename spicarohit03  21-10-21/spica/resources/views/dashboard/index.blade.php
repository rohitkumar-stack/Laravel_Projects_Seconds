                  ...
                  <div class="table-responsive">
                    ...
                    @foreach($students as $student)
                      <tr id="student_{{$student->id}}">
                        ...
                        <td>{{$student->date}}</td>
                        <td>
           <a href="#editEmployeeModal" class="edit editstudent" data-toggle="modal" data-id="{{$student->id}}"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>

           <a href="#deleteEmployeeModal" class="delete deletestudent" data-toggle="modal" data-id="{{$student->id}}"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                      </tr>
                      @endforeach
                   @endif
...
<div id="addEmployeeModal" class="modal fade">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form class="addstudentform" id="addstudent_form">
        @csrf
        ...
        <div class="modal-body">          
          ...
          <div class="form-group">
            <label>Gender</label>
            <select id="inputGender" class="form-control required" id="gender" name="gender">
        ...
        <div class="modal-footer">
          ...
          <input type="submit" class="btn btn-success add_student" value="Add">
        </div>
      </form>
    </div>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <input type="hidden" name="stud_id" id="stud_id" />
          ...
          <div class="form-group">
            <label> First Name</label>
            <input type="text" class="form-control" id="editfirstname"     value="" name="firstname"  required>

          </div>
           <div class="form-group">
            <label> Last Name</label>
            <input type="text" class="form-control" id="editlastname" value="" name="lastname"  required>
          </div>
          <div class="form-group">
            <label>Email</label>
            <input type="email" class="form-control" id="editemail"        value="" name="email" required>
          </div>
           <div class="form-group">
            <label>Gender</label>
         ...
         <div class="form-group">
            <label>Submited-Date</label>
             <input type="date" id="editdate" class="form-control" value="" name="date">
          </div>       
        </div>
        <div class="modal-footer">
          <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
          <input type="submit" class="btn btn-info update_student" value="Update">
        </div>
      </form>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form>
        ...
        <div class="modal-footer">
          <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
           <input type="hidden" name="deleteing_id" id="deleteing_id" value="" />
          <input type="submit" class="btn btn-danger delete_student" value="Delete">
        </div>
      </form>
    </div>
  </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 404) {
                        ...
                        $('#editfirstname').val(response.student.firstname);
                        $('#editlastname').val(response.student.lastname);
                        $('#editemail').val(response.student.email);
                        $('#editgender').val(response.student.gender);
                        $('#editdate').val(response.student.date);
                        $('#stud_id').val(stud_id);
                    }
                }
            });
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == 400) {
                        ...
                        let student_detail = response.student_detail;
                    // jQuery('tbody').append('<tr><td>'+student_detail.id+'</td><td>'+student_detail.firstname+'</td><td>'+student_detail.lastname+'</td><td>'+student_detail.email+'</td><td>'+student_detail.gender+'</td><td>'+student_detail.date+'</td><td><a href="#editEmployeeModal" value="'+student_detail.id+'" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a><a href="#deleteEmployeeModal" value="'+student_detail.id+'" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td></tr>');
                        $('#student_'+id).html('');
